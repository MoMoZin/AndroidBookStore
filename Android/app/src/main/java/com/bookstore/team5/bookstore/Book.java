...
public class Book extends HashMap<String, String> {
    ...
    final static String imageUrl="http://172.17.249.125/BookShopTeam5a/images";
    ...
    public static List<Book> getBookList() {
        bookList=jread("http://172.17.249.125/BookShopTeam5/Service.svc/Book", true);
        return bookList;
    }
    ...
    public static List<Book> testbook(){
        ...
        list.add(new Book(1111,"megan and me","fiction","9781484746424","Mr Awesome",12,"12.40"));
        list.add(new Book(1112,"How I became a magical princess","self-improvement","9780385376716","Mr Awesome",11,"12.00"));
        list.add(new Book(1113,"megan the explorer","erotica","9781619634480","Mr Awesome",10,"11.40"));
        return list;
    }
